...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.showLoadingSpinner = function() {
        ...
        spinner.innerHTML = '<div class="spinner-border spinner-border-lg text-primary" role="status"><span class="visually-hidden">Loading...</span></div>';
    ...
    window.showNotification = function(message, type = 'info') {
        ...
        var container = document.querySelector('main .container, main .container-fluid');
        if (container) {
